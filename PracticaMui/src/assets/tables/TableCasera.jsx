...
const styles= useStyles();
  ...
  const peticionPut=async()=>{
    await axios.put('https://us-west-2.data.tidbcloud.com/api/v1beta/app/dataapp-uYFCQhPa/endpoint/alterMaterial/id?'+consolaSeleccionada.id, consolaSeleccionada)
    .then(response=>{
      var dataNueva=data;
